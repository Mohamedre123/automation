  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "boolean",
        default: true,
        help: "لما عميل يسأل عن حاجة مش في المعلومات، البوت ميألّفش: بيقوله هتأكد وأرد عليك، ويبعتلك السؤال برقم. ترد انت «رد 3: الإجابة» ← الإجابة توصل للعميل، والبوت يحفظها ويرد بيها على اللي بعده. وتقدر تعلّمه أي وقت من رقمك: «اتعلم: المعلومة». كل اللي اتعلمه تشوفه وتعدّله من «اللي البوت اتعلمه» تحت",
      },
      {
        key: "ownerContact",
        ...
        help: "البوت بياخد التعليم من هنا بس - أي عميل تاني مايقدرش يعلّمه حاجة. واتساب: رقمك بالكود الدولي (لازم يكون رقم غير الرقم المربوط بالبوت). تيليجرام: @يوزرنيمك، وافتح البوت وابعتله /start مرة. فاضي = نفس «التحويل لموظف: يوصل لمين»",
      },
      {
        key: "ownerPauseHours",
        ...
        type: "number",
        default: 2,
        help: "واتساب WasenderAPI بس: لما ترد على عميل من موبايلك، البوت بيشوف ردك ويتعلم منه، وبيسيبك تكمل معاه من غير ما يقاطعك. عشان يشوف ردودك: في WasenderAPI ← Webhooks فعّل حدث Message Upsert جنب Message Received. 0 = يكمل يرد عادي",
      },

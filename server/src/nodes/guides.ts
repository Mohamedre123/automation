...
export const credentialGuides: Record<string, string[]> = {
  ...
  instagramBusiness: [
    "حوّل حساب إنستجرام لـ Business أو Creator (الإعدادات ← نوع الحساب).",
    "اربطه بصفحة فيسبوك (من إعدادات الصفحة ← Linked accounts ← Instagram).",
    "من Graph API Explorer اعمل توكن بصلاحيات instagram_basic و instagram_content_publish و pages_show_list و pages_read_engagement.",
    "اطلب me/accounts?fields=instagram_business_account - الرقم اللي جوه instagram_business_account هو Instagram User ID.",
    "مدّد التوكن من Access Token Debugger والصقه هنا.",
    "ملحوظة: إنستجرام بينشر صورة أو فيديو بس (مش نص لوحده)، والملف لازم يكون على رابط عام - صور وفيديوهات المنصة جاهزة لكده.",
  ],
  threadsApi: [

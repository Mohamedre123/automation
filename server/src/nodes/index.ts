...
const AUTO_FILL: Record<string, Record<string, NonNullable<FieldDef["autoFill"]>>> = {
  ...
  "telegram.sendPhoto": { caption: "caption", photo: "image", chatId: "replyTo" },
  "telegram.sendAlbum": { caption: "caption", photos: "images", chatId: "replyTo" },
  "telegram.sendVideo": { caption: "caption", video: "video", chatId: "replyTo" },
  ...
  "wordpress.uploadMedia": { imageUrl: "image" },
  "ghost.createPost": { html: "caption", imageUrl: "image" },
  "drive.upload": { fileUrl: "image" },
  // Messages carry the same content as posts: whatever the steps before wrote and made.
  "telegram.sendMessage": { text: "caption", chatId: "replyTo" },
  "wasender.send": { text: "caption", mediaUrl: "image", to: "replyTo" },
  "whatsapp.send": { text: "caption", mediaUrl: "image", to: "replyTo" },

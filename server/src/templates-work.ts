    ...
    graph: {
      nodes: [
        ...
        },
        {
          ...
          params: {
            ...
            system:
              ...
              "قواعد صارمة:\n" +
              "- ابحث فعلاً عن كل منافس بالاسم، ولو معاك رابط افتحه.\n" +
              "- اكتب الحقيقة اللي لقيتها بس. أي رقم أو سعر لازم يكون لقيته فعلاً - لو ملقتوش اكتب «مش لاقيه».\n" +
              "- ممنوع تخمّن أسعار أو أرقام متابعين أو تفاصيل من عندك.\n" +
              "- حط لينك المصدر جنب كل معلومة مهمة.\n" +
              "اكتب لكل منافس: بيبيع إيه بالظبط، نطاق الأسعار، العروض الحالية، نقط البيع اللي بيركز عليها، قنوات التواصل، وأي جديد آخر شهرين.",
            prompt:
        ...
        },
        {
          ...
          params: {
            system:
              "أنت مستشار تسويق بيكتب تقارير لصاحب مشروع صغير - بالعامية المصرية الواضحة، من غير مصطلحات فاضية.\n" +
              "اكتب التقرير بالترتيب ده بالظبط، بصيغة Markdown:\n\n" +
              "## الخلاصة في نص دقيقة\n" +
              "من 3 لـ 5 نقط: أهم حاجة لازم صاحب المشروع يعرفها دلوقتي.\n\n" +
              "## مقارنة سريعة\n" +
              "جدول Markdown أعمدته: المنافس | بيبيع إيه | نطاق السعر | أقوى حاجة عنده | أضعف حاجة عنده\n" +
              ...
              "الفجوات اللي لقيتها في السوق، وليه دي فرصة لمشروع العميل بالذات.\n\n" +
              "## خطة 30 يوم\n" +
              "من 5 لـ 7 خطوات عملية مرتبة بالأولوية. كل خطوة جملة واحدة يقدر ينفذها، مش نصيحة عامة.\n\n" +
              "## المصادر\n" +
              "لينكات اللي اتبنى عليه التقرير.\n\n" +
              "قواعد: متألّفش أي رقم مش موجود في نتايج البحث. لو معلومة ناقصة قول «مش متاح» وكمّل. اكتب التقرير بس من غير مقدمات.",
            prompt:
              "بيانات المشروع:\n{{2.text}}\n\n" +
        ...
        },
        {
          ...
          params: {
            ...
            text:
              ...
              "افتح الرابط ده من الموبايل، وفيه زرار «حفظ PDF» لو عايز تحفظه أو تبعته لحد:\n{{5.url}}",
          },
        },
      ],
    ...
    graph: {
      nodes: [
        ...
        },
        {
          ...
          name: "يوصلك على واتساب",
          position: at(4),
          params: { to: "", messageType: "text", text: "📈 تقرير النهاردة جاهز:\n{{4.url}}" },
        },
      ],

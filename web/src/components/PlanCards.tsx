...
export const CREDIT_FAQ: { q: string; a: string }[] = [
  {
    q: "يعني إيه كريديت؟",
    a: "كل خطوة بتكلّم تطبيق أو ذكاء اصطناعي (زي رد AI أو إرسال رسالة واتساب أو إضافة صف في شيت) = كريديت واحد. المحفّز وخطوات التنظيم (الشروط والفلاتر والتكرار وحفظ البيانات) مجاناً. يعني بوت واتساب بياخد 2 كريديت في الرسالة، فالـ 1,000 كريديت بتكفّي حوالي 500 رسالة.",
  },
  {
  ...
  },
  {
    ...
    a: "كريديت الباقة بيتجدد كل شهر بقيمتها. أما الكريديت الإضافي اللي بتشتريه فما بينتهيش، وبيتصرف بعد كريديت الشهر.",
  },
  {
    q: "إزاي بدفع؟",
    a: "حالياً بالتحويل على محفظة إلكترونية (فودافون كاش وغيرها) أو إنستاباي، وبعدها بتبعت صورة الإيصال على واتساب برسالة جاهزة فيها بياناتك، والباقة أو الكريديت بيتفعّلوا على حسابك بعد المراجعة.",
  },
  {
    q: "في تجربة مجانية؟",
